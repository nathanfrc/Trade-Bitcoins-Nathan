...
<html lang="pt">
  <head>
    ...
    <?php include "estrutura/biblioteca.php" ?>
      ...
      ?>
<div class="container">
  <h2> <h2> <span class="glyphicon glyphicon-bitcoin"></span>Bitcoins Cash -> CoinMakeBitcoins </h2></br></h2>
  <p>Informações do Bitcoins Cash</p>
  <table class="table">
    <thead>
      <tr>
      <th>Rank</th>
