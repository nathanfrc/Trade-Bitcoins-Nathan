...
<div class="coinmarketcap-currency-widget" data-currency="verge" data-base="USD"  data-secondary="BTC"></div>
      <?php  
      ...
      ?>
<div class="container">
  <h2> <h2> <span class="glyphicon glyphicon-bitcoin"></span>Verge </h2></br></h2>
  <p>Informações do Verge</p>
  <table class="table">
    <thead>
      <tr>
      <th>Rank</th>
