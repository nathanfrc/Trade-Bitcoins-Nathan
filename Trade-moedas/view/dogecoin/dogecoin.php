...
<html lang="pt">
  <head>
    ...
    <?php include "estrutura/biblioteca.php" ?>
      ...
      <div class="coinmarketcap-currency-widget" data-currency="dogecoin" data-base="USD"  data-secondary="BTC"></div>
      <?php  
      ...
      ?>
<div class="container">
  <h2> <h2> <span class="glyphicon glyphicon-bitcoin"></span>Dogecoin </h2></br></h2>
  <p>Informações do Dogecoin</p>
  <table class="table">
    <thead>
      <tr>
      <th>Rank</th>
